...
function InitializeGamemode()
	...
	Game_CreateRole("Venter",{255,216,0},"Vent and help crewmates by doing tasks[].",{0},1,2,false,true,255)
	...
	--counts
	Settings_CreateByte("Venter Count",0,2,0) -- 0
