...
public static class CE_CustomMapManager : CE_CustomMapManagerBase
{
    ...
    public static void Initialize()
    {
        ...
        static CE_MapInfo GetCurrentMap()
        {
    ...
    public static Vent CreateVent(string VentName, Vector3 Pos, Vent Left = null, Vent Right = null, Vent ReferenceVent = null)
    {
    ...
    public static class CE_CustomMapManagerBase
    {
        private static ShipStatus stat;
/*
        public static GameObject SpawnSprite(int x, int y, bool Solid)
        {
            ...
            static NormalPlayerTask ProcessCEMTask(CEM_Task ct)
            {
        ...
        private static NormalPlayerTask CreateTask(Type tasktype, SystemTypes room, int maxStep, TaskTypes tt, Type minigametype, string minigameName)
        {
            throw new NotImplementedException();
        }

        private static void MapTest(ShipStatus map, object AmbienceSounds)
        {
            ...
            Debug.Log("Test Vents Not Active");
            Debug.Log("Clearing Tasks...");
 //         LoadDefaultSounds(); // my god.. so my non created things AAAAAAAA.
            ...
            SystemConsole systemConsole = CreateSystemConsole(typeof(TaskAdderGame), new Vector3(5f, 5f, 0.5f), "TaskAddMinigame");
            Debug.Log("Clearing collision...");
            Debug.Log("Failed Clearing collision!");
        //  ClearMapCollision(map);
        //  TODO: kind of make custom maps work again...
            Debug.Log("Loading Map...");
            Debug.Log("Failed To Load!");
            Debug.Log("Are Custom Maps Are Not Enabled In This Build?");
    /*        CEM_Map maptospawn = GetCurrentMap() as CEM_Map; // someone make this work again... 
            string contentlocal = GetCurrentMap() as string; // this is getting annoying making them broken and not again.
            ...
            {
                int ambience = R.Ambience;
                int footsteps = R.Footsteps;
                ShipRoom shipRoom = CreateShipRoom((SystemTypes)R.RoomType, ambience, footsteps, new Vector3(R.Position.Values[0], R.Position.Values[1], R.Position.Values[2]), new Vector3(R.Scale.Values[0], R.Scale.Values[1], R.Scale.Values[2]));
            }
            ...
            UnityEngine.Object ReferenceVent = null;
        ...
        return;
private static SystemConsole CreateSystemConsole(Type type, Vector3 vector3, string v)
    {
        throw new NotImplementedException();
    }
    /*for (int x = -5; x < 5; x++)
...
SpawnSprite(x, y, BoolRange.Next(0.1f));
    ...
    private static void LoadDefaultSounds()
        ...
        private static ShipRoom CreateShipRoom(SystemTypes roomType, int ambience, int footsteps, Vector3 vector31, Vector3 vector32)
        {
            throw new NotImplementedException();
        }
    }