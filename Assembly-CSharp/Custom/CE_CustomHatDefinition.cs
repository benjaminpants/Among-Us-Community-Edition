public class CE_CustomHatDefinition
{
	...
	public float NormalPivotX
	{
		get;
		set;
	}

	public float NormalPivotY
	{
		get;
		set;
	}

	public float FloorPosX
	{
		get;
		set;
	}
	...
	public float FloorPivotX
	{
		get;
		set;
	}

	public float FloorPivotY
	{
		get;
		set;
	}
	...
	public float PreviewPivotX
	{
		get;
		set;
	}

	public float PreviewPivotY
	{
		get;
		set;
	}
