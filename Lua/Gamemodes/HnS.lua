...
function InitializeGamemode()
	return {"Hide And Seek",11} --Initialize a Gamemode with the name "Lua Test" and the ID of 6. In the future, the ID will be determined by the server/loader.
end
...
function DecideImpostors(impostorcount,playerinfos)
	local selected = {}
	for i=1, 1 do --repeat the below code for how many impostors there are in the settings
