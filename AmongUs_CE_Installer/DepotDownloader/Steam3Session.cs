    ...
    class Steam3Session
    {
        ...
        private void LogOnCallback( SteamUser.LoggedOnCallback loggedOn )
        {
            ...
            if ( isSteamGuard || is2FA || isLoginKey )
            {
                ...
                if ( is2FA )
                {
                    string message = "Please enter your 2 factor auth code from your authenticator app: ";
                    Console.Write(message);
                    logonDetails.TwoFactorCode = AmongUs_CE_Installer.ConsoleInput.ShowDialog(message);
                }
                else if ( isLoginKey )
                {
                ...
                {
                    string message = "Please enter the authentication code sent to your email address: ";
                    Console.Write(message);
                    logonDetails.AuthCode = AmongUs_CE_Installer.ConsoleInput.ShowDialog(message);
                }
